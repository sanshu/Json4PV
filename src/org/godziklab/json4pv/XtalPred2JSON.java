...
public class XtalPred2JSON extends HttpServlet {
    ...
    private static final String FFAS_PREFIX = "http://10.93.0.131/XtalPred-cgi/";
    ...
    protected void doGet(HttpServletRequest request,
        ...
        String url = FFAS_PREFIX + "download.pl?dir=" + dir + "/";

        String summaryUrl = FFAS_PREFIX + "download.pl?dir="
                + dir + "&type=summary";
